...
plt.subplot(311)
plt.grid(True)
plt.plot(tau, theta.transpose(), label=['theta_1', 'theta_2', 'theta_3'], linewidth=10)
plt.title("angle-time plot", fontsize=20)
plt.legend()
plt.xlabel("normalized time", fontsize=15)
plt.ylabel("angle theta (deg)", fontsize=15)

plt.subplot(312)
plt.grid(True)
plt.plot(tau, theta_dot.transpose(), label=['theta__dot_1', 'theta__dot_2', 'theta__dot_3'], linewidth=10)
plt.title("angular velocity-time plot", fontsize=20)
plt.legend()
plt.xlabel("normalized time", fontsize=15)
plt.ylabel("theta_dot (deg/s)", fontsize=15)

plt.subplot(313)
plt.grid(True)
plt.plot(tau, position.transpose(), label=['x', 'y', 'z'], linewidth=10)
