...
# -- MAIN --------------------------------------------------------------------------------------
# =================================================================================================
t = np.array([0, 5, 7, 8, 10, 15, 18])
q = np.array([3, -2, -5, 0, 6, 12, 8])
p = 4 

traj = BSpline(q, t, vi=2, vf=-3)
u = traj.get_u(t, p)
# print(traj.get_A(u))

u = np.array([0, 0, 0, 0, 1, 2, 4, 7, 7, 7, 7])
B = traj.get_B_P(u, 4.5, p=3)
print(B)
print(traj.get_B_P_derivative(u, B))