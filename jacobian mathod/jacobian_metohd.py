...
# in this section we calculate J_p and J_theta from the input of: geometric features and position of EE 
...
class Jacobian:
	...
	def get_jacobian_matrix(self): 
		...
		for i in [0, 1, 2]:
			...
			jz[i] = sin(self.theta_3[i])*sin(self.theta_1[i] + self.theta_2[i])
...
jac = Jacobian([0, 0, -0.38])
jac.get_theta_ij()
print(jac.get_jacobian_matrix())
